...
AtomCAP是一个面向PE/VC机构的投资决策管理系统原型，提供从策略制定、项目管理到假设验证、条款构建的全流程投资决策支持。
...
- 使用软删除
- 记录操作日志（created_at, updated_at, created_by）
- 评论使用单独表或JSONB字段
